...
- When writing or reviewing React UI/performance, follow `.agents/skills/react-best-practices/SKILL.md` (Vercel rules + tdbook SPA adaptations). Do not introduce Next.js, SWR, RSC, or extra data-fetch libraries to satisfy that skill.
